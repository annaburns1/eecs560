...
class MyLinkedList
{
  ...
  public:
    ...
    void reverseList()
    {
        ...
        *this = newList;
        // iterator temp2 = newList.begin();
        // for (int i=0; i<newList.theSize; i++) {
        //   this->push_front(*temp2);
        //   newList.pop_front();
        // }
        //this->appendList(newList);
        // while(this->empty() != true) {
        //   newList.push_front(this->back());
        //   this->pop_back();
        // }
        // *this = newList;
    ...
    {
        // code begins
        // while(rlist.empty() != true) {
        //   this->push_back(rlist.front());
        //   rlist.pop_front();
        // }
        // return *this;
        iterator temp = rlist.begin();
        while(rlist.empty() != true) {
          this->push_back(*temp);
          rlist.pop_front();
          temp = rlist.begin();
